...
export default function MyCharacterScreen() {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        source={require("../../src/img/room_background.png")}
      ...
      >
        <View style={styles.topHeader}>
          <View style={styles.levelWrapper}>
            ...
            <Image
              source={require("../../src/img/greenLvGauge.png")}
              style={styles.levelFrame}
              resizeMode="contain"
            />
          </View>
          <ImageBackground
            source={require("../../src/img/coin.png")}
            style={styles.coinBg}
            resizeMode="contain"
          >
        ...
        <View style={styles.characterArea}>
          <Image
            source={require("../../src/img/greenLv1.png")}
        ...
        <View style={styles.statusSection}>
          <View style={styles.stateWrapper}>
            ...
            <Image
              source={require("../../src/img/greenStateGauge.png")}
        ...
        <View style={styles.bottomMenu}>
          <View style={styles.buttonRow}>
            <TouchableOpacity style={styles.button} onPress={() => router.push("/info")}>
              <Image
                source={require("../../src/img/info_button.png")}
                style={styles.icon}
                resizeMode="contain"
              />
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => router.push("/closet")}>
              <Image
                source={require("../../src/img/closet_button.png")}
                style={styles.icon}
                resizeMode="contain"
              />
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => router.push("/achievements")}>
              <Image
                source={require("../../src/img/achievements_button.png")}
                style={styles.icon}
                resizeMode="contain"
              />
            </TouchableOpacity>
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity style={styles.button} onPress={() => router.push("/fortune")}>
              <Image
                source={require("../../src/img/fortune_button.png")}
                style={styles.icon}
                resizeMode="contain"
              />
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => router.push("/walk")}>
              <Image
                source={require("../../src/img/walk_button.png")}
                style={styles.icon}
                resizeMode="contain"
              />
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => router.push("/toilet")}>
              <Image
                source={require("../../src/img/toilet_button.png")}
                style={styles.icon}
                resizeMode="contain"
              />
            </TouchableOpacity>
